...
const defaultContainerVariants: Variants = { visible: { transition: { staggerChildren: 0.1 } } };
...
const presetVariants: Record<PresetType, Variants> = {
    ...
    bounce: { hidden: { y: -50 }, visible: { transition: { damping: 10, stiffness: 400, type: 'spring' }, y: 0 } },
    fade: {},
    flip: {
        hidden: { rotateX: -90 },
        visible: { rotateX: 0, transition: { damping: 20, stiffness: 300, type: 'spring' } },
    },
    rotate: {
        hidden: { rotate: -180 },
        visible: { rotate: 0, transition: { damping: 15, stiffness: 200, type: 'spring' } },
    },
    scale: { hidden: { scale: 0.8 }, visible: { scale: 1 } },
    slide: { hidden: { y: 20 }, visible: { y: 0 } },
    swing: {
        hidden: { rotate: -10 },
        visible: { rotate: 0, transition: { damping: 8, stiffness: 300, type: 'spring' } },
    },
    zoom: {
        hidden: { scale: 0.5 },
        visible: { scale: 1, transition: { damping: 20, stiffness: 300, type: 'spring' } },
    },
};
